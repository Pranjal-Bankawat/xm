	...
	dependencies: {
		...
		'@sapn/elsa': {
			...
			dependencies: {
				'@grpc/grpc-js': {
					version: '1.7.3',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/@grpc/grpc-js/-/grpc-js-1.7.3.tgz'
				},
				'@sapn/assert': {
					version: '1.2.3'
				},
				...
				express: {
					version: '4.18.2',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/express/-/express-4.18.2.tgz'
				}
			}
		},
		'@sapn/elsa-cli': {
			...
			dependencies: {
				...
				'aws-sdk': {
					version: '2.1253.0',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/aws-sdk/-/aws-sdk-2.1253.0.tgz'
				},
				chalk: {
					version: '4.1.2',
				...
				eslint: {
					version: '8.27.0',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/eslint/-/eslint-8.27.0.tgz'
				},
				glob: {
					version: '7.2.0',
				...
				semver: {
					version: '7.3.5',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/semver/-/semver-7.3.5.tgz'
				},
				'ts-protoc-gen': {
					version: '0.15.0',
				...
				yargs: {
					version: '17.6.2',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/yargs/-/yargs-17.6.2.tgz'
				}
			}
		},
		'@sapn/elsa-job': {
		...
		'@sapn/elsa-util': {
			...
			dependencies: {
				...
				'loader-utils': {
					version: '2.0.4',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/loader-utils/-/loader-utils-2.0.4.tgz'
				},
				minimatch: {
					version: '3.0.5'
				},
				...
				webpack: {
					version: '5.72.1',
					resolved: 'https://int.repositories.cloud.sap/artifactory/api/npm/build-milestones-npm/webpack/-/webpack-5.72.1.tgz'
				}
			}
		},
		'@sapn/fetch': {
